...
var Remote      = require('SupplyFinanceChain-lib').Remote;
var Transaction = require('SupplyFinanceChain-lib').Transaction;
var UInt160     = require('SupplyFinanceChain-lib').UInt160;
var Amount      = require('SupplyFinanceChain-lib').Amount;
...
//  console.log(JSON.stringify(dir_entry, undefined, 2));
  ...
  ledger.accountState.forEach(function (entry) {
      ...
      else if (entry.LedgerEntryType === 'SupplyFinanceChainState')
      {
        ...
        if (entry.HighLimit.issuer === entry.LowLimit.issuer)
          SupplyFinanceChain_selfs[entry.Account] = entry;
      }
  ...
  if (Object.keys(SupplyFinanceChain_selfs).length)
    console.log("SupplyFinanceChainState selfs = %s", Object.keys(SupplyFinanceChain_selfs).length);
