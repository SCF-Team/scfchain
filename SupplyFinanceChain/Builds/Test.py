...
CMAKE_UNITY_COMBOS = { '' : [['SupplyFinanceChaind'], CMAKE_UNITY_CONFIGS],
    '.nounity' : [['SupplyFinanceChaind'], CMAKE_NONUNITY_CONFIGS] }
...
parser = argparse.ArgumentParser(
    description='Test.py - run SupplyFinanceChain tests'
)
    ...
    for args in generator_options:
        for build_dirs, (build_targets, build_configs) in build_dir_targets.items():
            ...
            if not build_targets:
                build_targets = ('SupplyFinanceChaind',)
