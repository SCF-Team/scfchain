...
#include <SupplyFinanceChain/rpc/handlers/Version.h>
...
Handler const handlerArray[] {
    ...
    {   "noSupplyFinanceChain_check",       byRef (&doNoSupplyFinanceChainCheck),       Role::USER,  NO_CONDITION  },
...
//      {   "profile",              byRef (&doProfile),             Role::USER,  NEEDS_CURRENT_LEDGER  },
    ...
    {   "SupplyFinanceChain_path_find",     byRef (&doSupplyFinanceChainPathFind),      Role::USER,  NO_CONDITION  },
