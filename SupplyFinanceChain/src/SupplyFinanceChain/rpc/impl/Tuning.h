...
#ifndef SUPPLYFINANCECHAIN_RPC_TUNING_H_INCLUDED
#define SUPPLYFINANCECHAIN_RPC_TUNING_H_INCLUDED
...
/** Limits for the no_SupplyFinanceChain_check command. */
static LimitRange const noSupplyFinanceChainCheck = {10, 300, 400};
