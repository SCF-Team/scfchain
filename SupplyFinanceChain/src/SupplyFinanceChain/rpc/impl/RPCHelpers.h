...
#ifndef SUPPLYFINANCECHAIN_RPC_RPCHELPERS_H_INCLUDED
#define SUPPLYFINANCECHAIN_RPC_RPCHELPERS_H_INCLUDED

#include <SupplyFinanceChain/beast/core/SemanticVersion.h>
...
boost::optional<Seed>
parseSupplyFinanceChainLibSeed(Json::Value const& params);
