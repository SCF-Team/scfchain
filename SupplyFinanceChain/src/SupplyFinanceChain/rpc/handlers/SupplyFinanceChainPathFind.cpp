...
Json::Value doSupplyFinanceChainPathFind (RPC::Context& context)
{
        ...
        ! context.params.isMember(jss::ledger_hash))
    {
        ...
        //
        // 1. We're running doSupplyFinanceChainPathFind() due to a call to
        //    SupplyFinanceChain_path_find.  doSupplyFinanceChainPathFind() is currently running
        //    inside of a JobQueue::Coro using a JobQueue thread.
        //
        // 2. doSupplyFinanceChainPathFind's call to makeLegacyPathRequest() enqueues the
        ...
        // SupplyFinanceChaind source code) shutting down the application.  The code to
