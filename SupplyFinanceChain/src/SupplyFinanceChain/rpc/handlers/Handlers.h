...
#ifndef SUPPLYFINANCECHAIN_RPC_HANDLERS_HANDLERS_H_INCLUDED
#define SUPPLYFINANCECHAIN_RPC_HANDLERS_HANDLERS_H_INCLUDED
...
Json::Value doNoSupplyFinanceChainCheck         (RPC::Context&);
...
Json::Value doSupplyFinanceChainPathFind        (RPC::Context&);
