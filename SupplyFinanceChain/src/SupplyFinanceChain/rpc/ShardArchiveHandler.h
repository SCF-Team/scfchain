...
#ifndef SUPPLYFINANCECHAIN_RPC_SHARDARCHIVEHANDLER_H_INCLUDED
#define SUPPLYFINANCECHAIN_RPC_SHARDARCHIVEHANDLER_H_INCLUDED
...
#include <SupplyFinanceChain/net/SSLHTTPDownloader.h>
