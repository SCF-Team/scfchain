        ...
        STAmount const& amount) const
{
    ...
    */
    ...
    if (isSFC(issuer) && adjustedAmt < beast::zero)
        // A calculated negative SFC balance is not an error case. Consider a
        // payment snippet that credits a large SFC amount and then debits the
...
PaymentSandbox::balanceChanges (ReadView const& view) const
{
    ...
    // get the change in SFC balance, Account == root, issuer == root, currency == SFC
...
SFCAmount PaymentSandbox::sfcDestroyed () const
{
