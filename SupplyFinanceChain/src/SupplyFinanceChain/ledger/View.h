...
#ifndef SUPPLYFINANCECHAIN_LEDGER_VIEW_H_INCLUDED
#define SUPPLYFINANCECHAIN_LEDGER_VIEW_H_INCLUDED
...
// Return the account's liquid (not reserved) SFC.  Generally prefer
