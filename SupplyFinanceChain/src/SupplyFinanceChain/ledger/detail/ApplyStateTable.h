...
#ifndef SUPPLYFINANCECHAIN_LEDGER_APPLYSTATETABLE_H_INCLUDED
#define SUPPLYFINANCECHAIN_LEDGER_APPLYSTATETABLE_H_INCLUDED

#include <SupplyFinanceChain/ledger/OpenView.h>
#include <SupplyFinanceChain/ledger/RawView.h>
...
public:
    ...
    // For debugging
    SFCAmount const& dropsDestroyed () const
    {
