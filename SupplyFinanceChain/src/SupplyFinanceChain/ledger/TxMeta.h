...
#ifndef SUPPLYFINANCECHAIN_APP_TX_TRANSACTIONMETA_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_TX_TRANSACTIONMETA_H_INCLUDED
...
// VFALCO Move to SupplyFinanceChain/app/ledger/detail, rename to TxMeta
class TxMeta
{
public:
