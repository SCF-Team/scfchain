...
#ifndef SUPPLYFINANCECHAIN_LEDGER_READVIEW_H_INCLUDED
#define SUPPLYFINANCECHAIN_LEDGER_READVIEW_H_INCLUDED

#include <SupplyFinanceChain/ledger/detail/ReadViewFwdRange.h>
...
#include <SupplyFinanceChain/ledger/detail/ReadViewFwdRange.ipp>
