...
#ifndef SUPPLYFINANCECHAIN_APP_LEDGER_LEDGERTIMING_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_LEDGER_LEDGERTIMING_H_INCLUDED
...
/** Calculates the close time resolution for the specified ledger.
    ...
    The SupplyFinanceChain protocol uses binning to represent time intervals using only one
