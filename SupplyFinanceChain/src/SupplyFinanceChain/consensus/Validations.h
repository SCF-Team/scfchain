...
#ifndef SUPPLYFINANCECHAIN_CONSENSUS_VALIDATIONS_H_INCLUDED
#define SUPPLYFINANCECHAIN_CONSENSUS_VALIDATIONS_H_INCLUDED
...
#include <SupplyFinanceChain/consensus/LedgerTrie.h>
