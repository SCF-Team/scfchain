...
#ifndef SUPPLYFINANCECHAIN_APP_MISC_VALIDATORLIST_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_MISC_VALIDATORLIST_H_INCLUDED
...
/**
    ...
    SupplyFinanceChaind accepts ledger proposals and validations from trusted validator
    ...
    This class manages the set of validation public keys the local SupplyFinanceChaind node
    ...
    @li @c "blob": Base64-encoded JSON string containing a @c "sequence", @c
        ...
        SupplyFinanceChain timestamp (seconds since January 1st, 2000 (00:00 UTC)) for when
