...
#ifndef SUPPLYFINANCECHAIN_APP_MISC_DETAIL_WORKSSL_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_MISC_DETAIL_WORKSSL_H_INCLUDED

#include <SupplyFinanceChain/app/misc/detail/WorkBase.h>
#include <SupplyFinanceChain/net/RegisterSSLCerts.h>
