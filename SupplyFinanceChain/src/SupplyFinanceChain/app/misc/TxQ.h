...
/*
    ...
    Copyright (c) 2012-14 SupplyFinanceChain Labs Inc.
...
#ifndef SUPPLYFINANCECHAIN_TXQ_H_INCLUDED
#define SUPPLYFINANCECHAIN_TXQ_H_INCLUDED
    ...
    */
    ...
    public:
        ...
        /**
            ...
            @param app SupplyFinanceChaind Application object.
            @param view View of the LCL that was just closed or received.
            @param timeLeap Indicates that SupplyFinanceChaind is under load so fees
            should grow faster.
