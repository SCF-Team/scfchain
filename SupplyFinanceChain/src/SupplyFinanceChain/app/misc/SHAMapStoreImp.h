...
#ifndef SUPPLYFINANCECHAIN_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED
...
#include <SupplyFinanceChain/nodestore/DatabaseRotating.h>
...
private:
    ...
    std::string const dbPrefix_ = "SupplyFinanceChaindb";
...
private:
    ...
    // If SupplyFinanceChaind is not healthy, defer rotate-delete.
