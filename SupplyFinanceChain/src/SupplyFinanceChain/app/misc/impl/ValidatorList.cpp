...
#include <SupplyFinanceChain/basics/date.h>
    ...
    std::size_t trusted, std::size_t seen)
{
    ...
    // overlap.
    //
    // Theorem 8 of the Analysis of the SFC Ledger Consensus Protocol
    // (https://arxiv.org/abs/1802.07242) says:
    //     SFC LCP guarantees fork safety if Oi,j > nj/2 + ni − qi + ti,j for
