...
#ifndef SUPPLYFINANCECHAIN_APP_CONSENSUS_RCLCXLEDGER_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_CONSENSUS_RCLCXLEDGER_H_INCLUDED
...
public:
    ...
    */
    ...
    closeAgree() const
    {
        return SupplyFinanceChain::getCloseAgree(ledger_->info());
    }
    ...
    getJson() const
    {
        return SupplyFinanceChain::getJson(*ledger_);
    }
