...
#ifndef SUPPLYFINANCECHAIN_APP_CONSENSUSS_VALIDATIONS_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_CONSENSUSS_VALIDATIONS_H_INCLUDED

#include <SupplyFinanceChain/app/ledger/Ledger.h>
#include <SupplyFinanceChain/basics/ScopedLock.h>
#include <SupplyFinanceChain/consensus/Validations.h>
...
public:
    using NodeKey = SupplyFinanceChain::PublicKey;
    using NodeID = SupplyFinanceChain::NodeID;
