...
#ifndef SUPPLYFINANCECHAIN_APP_CONSENSUS_RCLCENSORSHIPDETECTOR_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_CONSENSUS_RCLCENSORSHIPDETECTOR_H_INCLUDED

#include <SupplyFinanceChain/basics/algorithm.h>
