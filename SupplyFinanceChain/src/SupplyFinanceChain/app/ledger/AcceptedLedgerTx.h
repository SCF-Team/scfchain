...
#ifndef SUPPLYFINANCECHAIN_APP_LEDGER_ACCEPTEDLEDGERTX_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_LEDGER_ACCEPTEDLEDGERTX_H_INCLUDED
...
/**
    ...
    @ingroup SupplyFinanceChain_ledger
*/
