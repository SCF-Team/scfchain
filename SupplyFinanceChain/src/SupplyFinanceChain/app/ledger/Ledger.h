...
#ifndef SUPPLYFINANCECHAIN_APP_LEDGER_LEDGER_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_LEDGER_LEDGER_H_INCLUDED

#include <SupplyFinanceChain/ledger/TxMeta.h>
#include <SupplyFinanceChain/ledger/View.h>
#include <SupplyFinanceChain/ledger/CachedView.h>
...
public:
    ...
    /** Create the Genesis ledger.
        ...
        The account has an SFC balance equal to the total amount
        of SFC in the system. No more SFC than the amount which
    ...
    */
    ...
    void
    rawDestroySFC (SFCAmount const& fee) override
    {
        info_.drops -= fee;
    }
