...
#ifndef SUPPLYFINANCECHAIN_APP_LEDGER_INBOUNDLEDGERS_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_LEDGER_INBOUNDLEDGERS_H_INCLUDED

#include <SupplyFinanceChain/app/ledger/InboundLedger.h>
