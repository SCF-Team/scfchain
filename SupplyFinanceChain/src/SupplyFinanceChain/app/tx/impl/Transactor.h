...
#ifndef SUPPLYFINANCECHAIN_APP_TX_TRANSACTOR_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_TX_TRANSACTOR_H_INCLUDED
...
protected:
    ...
    AccountID     account_;
    SFCAmount     mPriorBalance;  // Balance before fees.
    SFCAmount     mSourceBalance; // Balance after fees.
...
protected:
    ...
    /** Compute the minimum fee required to process a transaction
        ...
        @param baseFee The base fee of a candidate transaction
            @see SupplyFinanceChain::calculateBaseFee
