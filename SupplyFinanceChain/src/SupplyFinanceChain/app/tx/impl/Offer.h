...
#ifndef SUPPLYFINANCECHAIN_APP_BOOK_OFFER_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_BOOK_OFFER_H_INCLUDED
...
template<>
inline
void TOffer<IOUAmount, SFCAmount>::setFieldAmounts ()
{
    m_entry->setFieldAmount (sfTakerPays, toSTAmount(m_amounts.in, issIn_));
...
template<>
inline
void TOffer<SFCAmount, IOUAmount>::setFieldAmounts ()
{
