...
#ifndef SUPPLYFINANCECHAIN_APP_BOOK_OFFERSTREAM_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_BOOK_OFFERSTREAM_H_INCLUDED

#include <SupplyFinanceChain/app/tx/impl/BookTip.h>
