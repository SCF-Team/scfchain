...
#ifndef SUPPLYFINANCECHAIN_APP_PATHS_PATHSTATE_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_PATHS_PATHSTATE_H_INCLUDED
...
class PathState : public CountedObject <PathState>
{
  public:
    ...
    TER checkNoSupplyFinanceChain (AccountID const& destinationAccountID,
