...
#ifndef SUPPLYFINANCECHAIN_APP_PATHS_PATHREQUESTS_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_PATHS_PATHREQUESTS_H_INCLUDED
...
public:
    ...
    std::shared_ptr<SupplyFinanceChainLineCache> getLineCache (
...
private:
    ...
    // Use a SupplyFinanceChainLineCache
    std::shared_ptr<SupplyFinanceChainLineCache>         mLineCache;
