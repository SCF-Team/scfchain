...
SupplyFinanceChainLineCache::SupplyFinanceChainLineCache(
...
SupplyFinanceChainLineCache::getSupplyFinanceChainLines (AccountID const& accountID)
{
    ...
    if (it.second)
        it.first->second = getSupplyFinanceChainStateItems (
            accountID, *mLedger);
