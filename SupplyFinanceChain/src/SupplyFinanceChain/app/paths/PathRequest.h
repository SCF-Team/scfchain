...
#ifndef SUPPLYFINANCECHAIN_APP_PATHS_PATHREQUEST_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_PATHS_PATHREQUEST_H_INCLUDED
...
public:
    ...
    // SupplyFinanceChain_path_find semantics
    ...
    std::pair<bool, Json::Value> doCreate (
        std::shared_ptr<SupplyFinanceChainLineCache> const&,
        Json::Value const&);
    ...
    // update jvStatus
    Json::Value doUpdate (
        std::shared_ptr<SupplyFinanceChainLineCache> const&, bool fast);
...
private:
    ...
    bool isValid (std::shared_ptr<SupplyFinanceChainLineCache> const& crCache);
    void setValid ();

    std::unique_ptr<Pathfinder> const&
    getPathFinder(std::shared_ptr<SupplyFinanceChainLineCache> const&,
    ...
    */
    bool
    findPaths (std::shared_ptr<SupplyFinanceChainLineCache> const&, int const, Json::Value&);
