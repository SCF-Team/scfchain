...
//
// Currency cannot be SFC because we are rippling.
//
...
TER PathCursor::reverseLiquidityForAccount () const
{
    ...
    // page section: https://SupplyFinanceChain.com/wiki/Transit_Fees#Implementation
    ...
    else if (!previousNodeIsAccount && nextNodeIsAccount)
    {
        ...
        else
        {
            ...
            // deliver -> redeem
            // TODO(tom): now we have more checking in nodeSupplyFinanceChain, these checks
            // might be redundant.
