...
#ifndef SUPPLYFINANCECHAIN_APP_PATHS_CURSOR_SUPPLYFINANCECHAINLIQUIDITY_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_PATHS_CURSOR_SUPPLYFINANCECHAINLIQUIDITY_H_INCLUDED
