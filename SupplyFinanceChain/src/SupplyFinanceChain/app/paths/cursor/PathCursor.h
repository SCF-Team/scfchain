...
#ifndef SUPPLYFINANCECHAIN_APP_PATHS_CURSOR_PATHCURSOR_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_PATHS_CURSOR_PATHCURSOR_H_INCLUDED
...
public:
    PathCursor(
        ...
        NodeIndex nodeIndex = 0)
            : SupplyFinanceChainCalc_(SupplyFinanceChainCalc),
...
private:
    ...
    {
        return {SupplyFinanceChainCalc_, pathState_, multiQuality_, j_, nodeIndex_ + delta};
    }
    ...
    */
    ...
    SupplyFinanceChainCalc& SupplyFinanceChainCalc_;
