...
#ifndef SUPPLYFINANCECHAIN_APP_PATHS_ACCOUNTCURRENCIES_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_PATHS_ACCOUNTCURRENCIES_H_INCLUDED
...
accountSourceCurrencies(
    AccountID const& account,
        std::shared_ptr<SupplyFinanceChainLineCache> const& lrLedger,
             bool includeSFC);
