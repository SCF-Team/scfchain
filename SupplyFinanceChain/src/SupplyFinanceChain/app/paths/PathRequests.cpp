...
/** Get the current SupplyFinanceChainLineCache, updating it if necessary.
    Get the correct ledger to use.
*/
std::shared_ptr<SupplyFinanceChainLineCache>
    ...
    bool authoritative)
{
    ...
    {
        mLineCache = std::make_shared<SupplyFinanceChainLineCache> (ledger);
    }
    return mLineCache;
}
                              ...
                              Job::CancelCallback shouldCancel)
{
    ...
    std::shared_ptr<SupplyFinanceChainLineCache> cache;
...
// Make an old-style SupplyFinanceChain_path_find request
Json::Value
...
PathRequests::doLegacyPathRequest (
        ...
        Json::Value const& request)
{
    auto cache = std::make_shared<SupplyFinanceChainLineCache> (inLedger);
