...
#ifndef SUPPLYFINANCECHAIN_APP_PATHS_IMPL_PAYSTEPS_H_INCLUDED
#define SUPPLYFINANCECHAIN_APP_PATHS_IMPL_PAYSTEPS_H_INCLUDED
...
/**
   ...
   There are five concrete step classes:
     ...
     BookStepIX is an IOU/SFC offer book
     BookStepXI is an SFC/IOU offer book
     SFCEndpointStep is the source or destination account for SFC
...
public:
    ...
    */
    ...
    /**
       ...
       account. This is needed for checkNoSupplyFinanceChain.
    */
    ...
    // For SFC endpoints, one of src or dst will be the root account
...
/*
   ...
   @param path Liquidity sources to use for this strand of the payment. The path
               ...
               accounts to SupplyFinanceChain through.
...
struct StrandContext
{
    ...
    /** The previous step in the strand. Needed to check the no SupplyFinanceChain
        constraint
     */
