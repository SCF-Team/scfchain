...
#include <SupplyFinanceChain/app/main/BasicApp.h>
#include <SupplyFinanceChain/app/main/Tuning.h>
...
#include <SupplyFinanceChain/app/main/LoadManager.h>
#include <SupplyFinanceChain/app/main/NodeIdentity.h>
#include <SupplyFinanceChain/app/main/NodeStoreScheduler.h>
...
#include <SupplyFinanceChain/app/misc/SHAMapStore.h>
#include <SupplyFinanceChain/app/misc/TxQ.h>
#include <SupplyFinanceChain/app/misc/ValidatorSite.h>
...
#include <SupplyFinanceChain/basics/ResolverAsio.h>
#include <SupplyFinanceChain/basics/safe_cast.h>
#include <SupplyFinanceChain/basics/Sustain.h>
#include <SupplyFinanceChain/basics/PerfLog.h>
#include <SupplyFinanceChain/json/json_reader.h>
#include <SupplyFinanceChain/nodestore/DummyScheduler.h>
#include <SupplyFinanceChain/overlay/Cluster.h>
#include <SupplyFinanceChain/overlay/make_Overlay.h>
#include <SupplyFinanceChain/protocol/BuildInfo.h>
...
#include <SupplyFinanceChain/beast/asio/io_latency_probe.h>
...
public:
    ...
    {
    #if SUPPLYFINANCECHAIN_SINGLE_IO_SERVICE_THREAD
        return 1;
    #else
            ...
            if (freeSpace < megabytes(512))
            {
                JLOG(m_journal.fatal())
                    << "Free SQLite space for transaction db is less than "
                       "512MB. To fix this, SupplyFinanceChaind must be executed with the "
