...
#ifndef SUPPLYFINANCECHAIN_CONDITIONS_PREIMAGE_SHA256_H
#define SUPPLYFINANCECHAIN_CONDITIONS_PREIMAGE_SHA256_H
...
#include <SupplyFinanceChain/conditions/impl/error.h>
