...
#include <SupplyFinanceChain/nodestore/impl/ManagerImp.h>
...
ManagerImp::missing_backend()
{
    Throw<std::runtime_error> (
        "Your SupplyFinanceChaind.cfg is missing a [node_db] entry, "
        "please see the SupplyFinanceChaind-example.cfg file!"
        );
}
