...
#ifndef SUPPLYFINANCECHAIN_NODESTORE_BATCHWRITER_H_INCLUDED
#define SUPPLYFINANCECHAIN_NODESTORE_BATCHWRITER_H_INCLUDED

#include <SupplyFinanceChain/nodestore/Scheduler.h>
#include <SupplyFinanceChain/nodestore/Task.h>
