...
#ifndef SUPPLYFINANCECHAIN_NODESTORE_CODEC_H_INCLUDED
#define SUPPLYFINANCECHAIN_NODESTORE_CODEC_H_INCLUDED
...
#include <SupplyFinanceChain/nodestore/impl/varint.h>
