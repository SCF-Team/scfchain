...
#ifndef SUPPLYFINANCECHAIN_NODESTORE_DATABASE_H_INCLUDED
#define SUPPLYFINANCECHAIN_NODESTORE_DATABASE_H_INCLUDED

#include <SupplyFinanceChain/basics/TaggedCache.h>
#include <SupplyFinanceChain/basics/KeyCache.h>
#include <SupplyFinanceChain/core/Stoppable.h>
#include <SupplyFinanceChain/nodestore/Backend.h>
#include <SupplyFinanceChain/nodestore/impl/Tuning.h>
#include <SupplyFinanceChain/nodestore/Scheduler.h>
#include <SupplyFinanceChain/nodestore/NodeObject.h>
...
private:
    ...
    // The default is 32570 to match the SFC ledger network's earliest
    // allowed sequence. Alternate networks may set this value.
    std::uint32_t earliestSeq_ {SFC_LEDGER_EARLIEST_SEQ};
