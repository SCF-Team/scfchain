...
#ifndef SUPPLYFINANCECHAIN_WEBSOCKET_AUTOSOCKET_AUTOSOCKET_H_INCLUDED
#define SUPPLYFINANCECHAIN_WEBSOCKET_AUTOSOCKET_AUTOSOCKET_H_INCLUDED
...
public:
    ...
    {
        using namespace SupplyFinanceChain;
