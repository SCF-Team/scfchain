...
#ifndef SUPPLYFINANCECHAIN_PEERFINDER_SLOTIMP_H_INCLUDED
#define SUPPLYFINANCECHAIN_PEERFINDER_SLOTIMP_H_INCLUDED

#include <SupplyFinanceChain/peerfinder/Slot.h>
