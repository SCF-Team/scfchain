...
#ifndef SUPPLYFINANCECHAIN_PROTOCOL_ACCOUNTID_H_INCLUDED
#define SUPPLYFINANCECHAIN_PROTOCOL_ACCOUNTID_H_INCLUDED

#include <SupplyFinanceChain/protocol/tokens.h>
...
/** A special account that's used as the "issuer" for SFC. */
AccountID const&
sfcAccount();
...
/** Caches the base58 representations of AccountIDs
    ...
    justify having a cache. In the future, SupplyFinanceChaind should
...
public:
    ...
    /** Return SupplyFinanceChain::toBase58 for the AccountID
...
template <>
struct hash <SupplyFinanceChain::AccountID> : SupplyFinanceChain::AccountID::hasher
{
