...
#ifndef SUPPLYFINANCECHAIN_PROTOCOL_KNOWNFORMATS_H_INCLUDED
#define SUPPLYFINANCECHAIN_PROTOCOL_KNOWNFORMATS_H_INCLUDED

#include <SupplyFinanceChain/basics/contract.h>
#include <SupplyFinanceChain/protocol/SOTemplate.h>
