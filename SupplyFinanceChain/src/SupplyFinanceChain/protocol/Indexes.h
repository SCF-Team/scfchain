...
#ifndef SUPPLYFINANCECHAIN_PROTOCOL_INDEXES_H_INCLUDED
#define SUPPLYFINANCECHAIN_PROTOCOL_INDEXES_H_INCLUDED

#include <SupplyFinanceChain/protocol/Keylet.h>
...
struct line_t
{
    ...
    {
        return { ltSUPPLYFINANCECHAIN_STATE, key };
    }
};
