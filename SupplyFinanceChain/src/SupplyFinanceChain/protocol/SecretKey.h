...
#ifndef SUPPLYFINANCECHAIN_PROTOCOL_SECRETKEY_H_INCLUDED
#define SUPPLYFINANCECHAIN_PROTOCOL_SECRETKEY_H_INCLUDED

#include <SupplyFinanceChain/basics/Buffer.h>
#include <SupplyFinanceChain/basics/Slice.h>
#include <SupplyFinanceChain/crypto/KeyType.h> // move to protocol/
...
/** Generate a key pair deterministically.
    ...
    This algorithm is specific to SupplyFinanceChain:
