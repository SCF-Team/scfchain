...
static char SupplyFinanceChainAlphabet[] =
...
{
    return encodeToken(type, token, size, SupplyFinanceChainAlphabet);
}
...
/*  Base58 decode a SupplyFinanceChain token
...
static InverseAlphabet SupplyFinanceChainInverse(SupplyFinanceChainAlphabet);
...
{
    return decodeBase58Token(s, type, SupplyFinanceChainInverse);
}
