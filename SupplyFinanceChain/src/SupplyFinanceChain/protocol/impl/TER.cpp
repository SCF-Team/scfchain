...
transResults()
{
    ...
    results
    {
        ...
        { tecNO_DST,                 { "tecNO_DST",                "Destination does not exist. Send SFC to create it."                            } },
        { tecNO_DST_INSUF_SFC,       { "tecNO_DST_INSUF_SFC",      "Destination does not exist. Too little SFC sent to create it."                 } },
        ...
        { tecUNFUNDED_ADD,           { "tecUNFUNDED_ADD",          "Insufficient SFC balance for WalletAdd."                                       } },
        { tecUNFUNDED_OFFER,         { "tecUNFUNDED_OFFER",        "Insufficient balance to fund created offer."                                   } },
        { tecUNFUNDED_PAYMENT,       { "tecUNFUNDED_PAYMENT",      "Insufficient SFC balance to send."                                             } },
        ...
        { temBAD_FEE,                { "temBAD_FEE",               "Invalid fee, negative or not SFC."                                             } },
        ...
        { temBAD_SEND_SFC_LIMIT,     { "temBAD_SEND_SFC_LIMIT",    "Malformed: Limit quality is not allowed for SFC to SFC."                       } },
        { temBAD_SEND_SFC_MAX,       { "temBAD_SEND_SFC_MAX",      "Malformed: Send max is not allowed for SFC to SFC."                            } },
        { temBAD_SEND_SFC_NO_DIRECT, { "temBAD_SEND_SFC_NO_DIRECT","Malformed: No SupplyFinanceChain direct is not allowed for SFC to SFC."                    } },
        { temBAD_SEND_SFC_PARTIAL,   { "temBAD_SEND_SFC_PARTIAL",  "Malformed: Partial payment is not allowed for SFC to SFC."                     } },
        { temBAD_SEND_SFC_PATHS,     { "temBAD_SEND_SFC_PATHS",    "Malformed: Paths are not allowed for SFC to SFC."                              } },
        ...
        { temSUPPLYFINANCECHAIN_EMPTY,           { "temSUPPLYFINANCECHAIN_EMPTY",          "PathSet with no paths."                                                        } },
        ...
        { terNO_SUPPLYFINANCECHAIN,              { "terNO_SUPPLYFINANCECHAIN",             "Path does not permit rippling."                                                } },
