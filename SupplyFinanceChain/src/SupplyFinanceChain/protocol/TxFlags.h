...
#ifndef SUPPLYFINANCECHAIN_PROTOCOL_TXFLAGS_H_INCLUDED
#define SUPPLYFINANCECHAIN_PROTOCOL_TXFLAGS_H_INCLUDED
...
const std::uint32_t asfDefaultSupplyFinanceChain       = 8;
...
// Payment flags:
const std::uint32_t tfNoSupplyFinanceChainDirect       = 0x00010000;
const std::uint32_t tfPartialPayment       = 0x00020000;
const std::uint32_t tfLimitQuality         = 0x00040000;
const std::uint32_t tfPaymentMask          = ~ (tfUniversal | tfPartialPayment | tfLimitQuality | tfNoSupplyFinanceChainDirect);

// TrustSet flags:
const std::uint32_t tfSetfAuth             = 0x00010000;
const std::uint32_t tfSetNoSupplyFinanceChain          = 0x00020000;
const std::uint32_t tfClearNoSupplyFinanceChain        = 0x00040000;
const std::uint32_t tfSetFreeze            = 0x00100000;
const std::uint32_t tfClearFreeze          = 0x00200000;
const std::uint32_t tfTrustSetMask         = ~ (tfUniversal | tfSetfAuth | tfSetNoSupplyFinanceChain | tfClearNoSupplyFinanceChain
