...
#ifndef SUPPLYFINANCECHAIN_PROTOCOL_LEDGERFORMATS_H_INCLUDED
#define SUPPLYFINANCECHAIN_PROTOCOL_LEDGERFORMATS_H_INCLUDED

#include <SupplyFinanceChain/protocol/KnownFormats.h>
...
enum LedgerEntryType
{
    ...
    */
    ...
    // Simple unidirection sfc channel
    ltPAYCHAN           = 'x',
...
enum LedgerSpecificFlags
{
    ...
    lsfDisallowSFC      = 0x00080000,   // True, to disallow sending SFC.
    lsfDisableMaster    = 0x00100000,   // True, force regular key
    lsfNoFreeze         = 0x00200000,   // True, cannot freeze SupplyFinanceChain states
    lsfGlobalFreeze     = 0x00400000,   // True, all assets frozen
    lsfDefaultSupplyFinanceChain    = 0x00800000,   // True, trust lines allow rippling by default
    ...
    // ltSUPPLYFINANCECHAIN_STATE
    lsfLowReserve       = 0x00010000,   // True, if entry counts toward reserve.
    lsfHighReserve      = 0x00020000,
    lsfLowAuth          = 0x00040000,
    lsfHighAuth         = 0x00080000,
    lsfLowNoSupplyFinanceChain      = 0x00100000,
    lsfHighNoSupplyFinanceChain     = 0x00200000,
