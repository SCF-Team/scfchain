...
#ifndef SUPPLYFINANCECHAIN_PROTOCOL_PUBLICKEY_H_INCLUDED
#define SUPPLYFINANCECHAIN_PROTOCOL_PUBLICKEY_H_INCLUDED
...
/** A public key.
    ...
    The format of the public key is SupplyFinanceChain specific,
