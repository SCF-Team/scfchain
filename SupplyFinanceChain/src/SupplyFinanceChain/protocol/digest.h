...
#ifndef SUPPLYFINANCECHAIN_PROTOCOL_DIGEST_H_INCLUDED
#define SUPPLYFINANCECHAIN_PROTOCOL_DIGEST_H_INCLUDED

#include <SupplyFinanceChain/basics/base_uint.h>
#include <SupplyFinanceChain/beast/crypto/ripemd.h>
#include <SupplyFinanceChain/beast/crypto/sha2.h>
#include <SupplyFinanceChain/beast/hash/endian.h>
#include <algorithm>
#include <array>

namespace SupplyFinanceChain {

/*  Message digest functions used in the SupplyFinanceChain Protocol
...
/** Returns the RIPEMD-160 digest of the SHA256 hash of the message.
    ...
    representing a SupplyFinanceChain account, from a message. Typically the
