...
#ifndef SUPPLYFINANCECHAIN_PROTOCOL_TOKENS_H_INCLUDED
#define SUPPLYFINANCECHAIN_PROTOCOL_TOKENS_H_INCLUDED
...
// Facilities for converting SupplyFinanceChain tokens
// to and from their human readable strings

/*  Base-58 encode a SupplyFinanceChain Token

    SupplyFinanceChain Tokens have a one-byte prefx indicating
