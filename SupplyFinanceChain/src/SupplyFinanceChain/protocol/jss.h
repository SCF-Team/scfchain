...
#ifndef SUPPLYFINANCECHAIN_PROTOCOL_JSONFIELDS_H_INCLUDED
#define SUPPLYFINANCECHAIN_PROTOCOL_JSONFIELDS_H_INCLUDED
...
JSS ( SupplyFinanceChainState );                // ledger type.
...
JSS ( alternatives );               // out: PathRequest, SupplyFinanceChainPathFind
...
JSS ( base_fee_sfc );               // out: NetworkOPs
...
JSS ( destination_account );        // in: PathRequest, SupplyFinanceChainPathFind, account_lines
                                    // out: AccountChannels
JSS ( destination_amount );         // in: PathRequest, SupplyFinanceChainPathFind
JSS ( destination_currencies );     // in: PathRequest, SupplyFinanceChainPathFind
...
JSS ( issuer );                     // in: SupplyFinanceChainPathFind, Subscribe,
...
JSS ( ledger_hash );                // in: RPCHelpers, LedgerRequest,
                                    //     SupplyFinanceChainPathFind, TransactionEntry,
                                    //     handlers/Ledger
...
JSS ( no_SupplyFinanceChain );                  // out: AccountLines
JSS ( no_SupplyFinanceChain_peer );             // out: AccountLines
...
JSS ( paths );                      // in: SupplyFinanceChainPathFind
JSS ( paths_canonical );            // out: SupplyFinanceChainPathFind
JSS ( paths_computed );             // out: PathRequest, SupplyFinanceChainPathFind
...
JSS ( reserve_base_sfc );           // out: NetworkOPs
JSS ( reserve_inc );                // out: NetworkOPs
JSS ( reserve_inc_sfc );            // out: NetworkOPs
JSS ( response );                   // websocket
JSS ( result );                     // RPC
JSS ( SupplyFinanceChain_lines );               // out: NetworkOPs
JSS ( SupplyFinanceChain_state );               // in: LedgerEntr
JSS ( SupplyFinanceChainrpc );                  // SupplyFinanceChain RPC version
JSS ( role );                       // out: Ping.cpp
JSS ( rpc );
JSS ( rt_accounts );                // in: Subscribe, Unsubscribe
JSS ( running_duration_us );
JSS ( sanity );                     // out: PeerImp
JSS ( search_depth );               // in: SupplyFinanceChainPathFind
...
JSS ( send_max );                   // in: PathRequest, SupplyFinanceChainPathFind
...
JSS ( source_account );             // in: PathRequest, SupplyFinanceChainPathFind
JSS ( source_amount );              // in: PathRequest, SupplyFinanceChainPathFind
JSS ( source_currencies );          // in: PathRequest, SupplyFinanceChainPathFind
