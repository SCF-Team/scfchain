...
#ifndef SUPPLYFINANCECHAIN_PROTOCOL_STACCOUNT_H_INCLUDED
#define SUPPLYFINANCECHAIN_PROTOCOL_STACCOUNT_H_INCLUDED
...
private:
    ...
    // overhead in a SupplyFinanceChain::uint160.  However, so the serialized format of the
