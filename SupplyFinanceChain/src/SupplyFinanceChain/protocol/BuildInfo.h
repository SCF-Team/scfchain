...
#ifndef SUPPLYFINANCECHAIN_PROTOCOL_BUILDINFO_H_INCLUDED
#define SUPPLYFINANCECHAIN_PROTOCOL_BUILDINFO_H_INCLUDED
...
/** Describes a SupplyFinanceChain/RTXP protocol version. */
