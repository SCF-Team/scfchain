...
/*
    ...
    Copyright (c) 2012 - 2018 SupplyFinanceChain Labs Inc.
...
#ifndef SUPPLYFINANCECHAIN_PROTOCOL_TER_H_INCLUDED
#define SUPPLYFINANCECHAIN_PROTOCOL_TER_H_INCLUDED
...
// See https://SupplyFinanceChain.com/wiki/Transaction_errors
//
...
enum TEMcodes : TERUnderlyingType
{
    ...
    temBAD_PATH_LOOP,
    temBAD_REGKEY,
    temBAD_SEND_SFC_LIMIT,
    temBAD_SEND_SFC_MAX,
    temBAD_SEND_SFC_NO_DIRECT,
    temBAD_SEND_SFC_PARTIAL,
    temBAD_SEND_SFC_PATHS,
    temBAD_SEQUENCE,
    temBAD_SIGNATURE,
    temBAD_SRC_ACCOUNT,
...
enum TERcodes : TERUnderlyingType
{
    ...
    terNO_SUPPLYFINANCECHAIN,        // Rippling not allowed
...
enum TECcodes : TERUnderlyingType
{
    ...
    // 100 .. 159 C
    //   Claim fee only (SupplyFinanceChain transaction with no good paths, pay to
