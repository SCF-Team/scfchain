...
#ifndef SUPPLYFINANCECHAIN_PROTOCOL_SFIELD_H_INCLUDED
#define SUPPLYFINANCECHAIN_PROTOCOL_SFIELD_H_INCLUDED
...
extern SF_Amount const sfSupplyFinanceChainEscrow;
