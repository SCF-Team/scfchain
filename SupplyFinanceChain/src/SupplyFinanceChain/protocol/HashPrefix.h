...
#ifndef SUPPLYFINANCECHAIN_PROTOCOL_HASHPREFIX_H_INCLUDED
#define SUPPLYFINANCECHAIN_PROTOCOL_HASHPREFIX_H_INCLUDED
...
/** Prefix for hashing functions.
    ...
    @note Hash prefixes are part of the SupplyFinanceChain protocol.
