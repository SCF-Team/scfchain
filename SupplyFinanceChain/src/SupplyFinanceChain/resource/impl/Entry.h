...
#ifndef SUPPLYFINANCECHAIN_RESOURCE_ENTRY_H_INCLUDED
#define SUPPLYFINANCECHAIN_RESOURCE_ENTRY_H_INCLUDED

#include <SupplyFinanceChain/basics/DecayingSample.h>
