...
#include <SupplyFinanceChain/overlay/impl/ConnectAttempt.h>
#include <SupplyFinanceChain/overlay/impl/PeerImp.h>
#include <SupplyFinanceChain/peerfinder/make_Manager.h>
#include <SupplyFinanceChain/rpc/json_body.h>
#include <SupplyFinanceChain/rpc/handlers/GetCounts.h>
...
OverlayImpl::onPrepare()
{
    ...
    {
        // Pool of servers operated by SupplyFinanceChain Labs Inc. - https://SupplyFinanceChain.com
        bootstrapIps.push_back("r.SupplyFinanceChain.com 51235");
    ...
    // Add the ips_fixed from the SupplyFinanceChaind.cfg file
...
/** The number of active peers on the network
    ...
    and are running the SupplyFinanceChain protocol.
*/
std::size_t
OverlayImpl::size()
{
...
OverlayImpl::getServerInfo()
{
    ...
    if (server_info.isMember(jss::validated_ledger))
    {
        ...
        validated_ledger.removeMember(jss::reserve_base_sfc);
        validated_ledger.removeMember(jss::reserve_inc_sfc);
    }
