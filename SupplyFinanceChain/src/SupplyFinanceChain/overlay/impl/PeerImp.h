...
#ifndef SUPPLYFINANCECHAIN_OVERLAY_PEERIMP_H_INCLUDED
#define SUPPLYFINANCECHAIN_OVERLAY_PEERIMP_H_INCLUDED
...
#include <SupplyFinanceChain/overlay/impl/ProtocolMessage.h>
#include <SupplyFinanceChain/overlay/impl/OverlayImpl.h>
...
public:
    ...
    */
    ...
    enum class State
    {
        ...
        /** Running the SupplyFinanceChain protocol actively */
        ,active
    };
...
public:
    ...
    */
    ...
    /** Return the version of SupplyFinanceChaind that the peer is running, if reported. */
    std::string
    getVersion() const;
