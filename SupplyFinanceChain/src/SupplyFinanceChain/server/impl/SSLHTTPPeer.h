...
#ifndef SUPPLYFINANCECHAIN_SERVER_SSLHTTPPEER_H_INCLUDED
#define SUPPLYFINANCECHAIN_SERVER_SSLHTTPPEER_H_INCLUDED

#include <SupplyFinanceChain/server/impl/BaseHTTPPeer.h>
#include <SupplyFinanceChain/server/impl/SSLWSPeer.h>
