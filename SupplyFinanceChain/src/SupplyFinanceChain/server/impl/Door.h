...
#ifndef SUPPLYFINANCECHAIN_SERVER_DOOR_H_INCLUDED
#define SUPPLYFINANCECHAIN_SERVER_DOOR_H_INCLUDED
...
#include <SupplyFinanceChain/server/impl/PlainHTTPPeer.h>
#include <SupplyFinanceChain/server/impl/SSLHTTPPeer.h>
