...
#ifndef SUPPLYFINANCECHAIN_SERVER_BASEHTTPPEER_H_INCLUDED
#define SUPPLYFINANCECHAIN_SERVER_BASEHTTPPEER_H_INCLUDED
...
#include <SupplyFinanceChain/beast/asio/ssl_error.h> // for is_short_read?
