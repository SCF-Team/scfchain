...
#ifndef SUPPLYFINANCECHAIN_SERVER_SERVERIMPL_H_INCLUDED
#define SUPPLYFINANCECHAIN_SERVER_SERVERIMPL_H_INCLUDED

#include <SupplyFinanceChain/basics/chrono.h>
#include <SupplyFinanceChain/server/Server.h>
#include <SupplyFinanceChain/server/impl/Door.h>
