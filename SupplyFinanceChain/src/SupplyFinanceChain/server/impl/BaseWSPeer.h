...
#ifndef SUPPLYFINANCECHAIN_SERVER_BASEWSPEER_H_INCLUDED
#define SUPPLYFINANCECHAIN_SERVER_BASEWSPEER_H_INCLUDED

#include <SupplyFinanceChain/basics/safe_cast.h>
#include <SupplyFinanceChain/server/impl/BasePeer.h>
