...
#ifndef SUPPLYFINANCECHAIN_SERVER_SIMPLEWRITER_H_INCLUDED
#define SUPPLYFINANCECHAIN_SERVER_SIMPLEWRITER_H_INCLUDED

#include <SupplyFinanceChain/server/Writer.h>
