...
#ifndef SUPPLYFINANCECHAIN_SERVER_SERVER_H_INCLUDED
#define SUPPLYFINANCECHAIN_SERVER_SERVER_H_INCLUDED

#include <SupplyFinanceChain/server/Port.h>
#include <SupplyFinanceChain/server/impl/ServerImpl.h>
