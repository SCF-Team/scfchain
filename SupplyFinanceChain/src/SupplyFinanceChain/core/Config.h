...
#ifndef SUPPLYFINANCECHAIN_CORE_CONFIG_H_INCLUDED
#define SUPPLYFINANCECHAIN_CORE_CONFIG_H_INCLUDED

#include <SupplyFinanceChain/basics/BasicConfig.h>
#include <SupplyFinanceChain/basics/base_uint.h>
#include <SupplyFinanceChain/protocol/SystemParameters.h> // VFALCO Breaks levelization
...
public:
    ...
    std::vector<std::string>    IPS;                    // Peer IPs from SupplyFinanceChaind.cfg.
    std::vector<std::string>    IPS_FIXED;              // Fixed Peer IPs from SupplyFinanceChaind.cfg.
    std::vector<std::string>    SNTP_SERVERS;           // SNTP servers from SupplyFinanceChaind.cfg.
