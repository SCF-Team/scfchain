...
#ifndef SUPPLYFINANCECHAIN_CORE_CLOSURE_COUNTER_H_INCLUDED
#define SUPPLYFINANCECHAIN_CORE_CLOSURE_COUNTER_H_INCLUDED
...
#endif // SUPPLYFINANCECHAIN_CORE_CLOSURE_COUNTER_H_INCLUDED
