...
#ifndef SUPPLYFINANCECHAIN_CORE_TIMEKEEPER_H_INCLUDED
#define SUPPLYFINANCECHAIN_CORE_TIMEKEEPER_H_INCLUDED
...
public:
    ...
    */
    ...
    /** Returns the estimate of wall time, in network time.
        ...
        The network time is wall time adjusted for the SupplyFinanceChain
