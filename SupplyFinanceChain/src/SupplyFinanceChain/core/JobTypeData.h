...
#ifndef SUPPLYFINANCECHAIN_CORE_JOBTYPEDATA_H_INCLUDED
#define SUPPLYFINANCECHAIN_CORE_JOBTYPEDATA_H_INCLUDED

#include <SupplyFinanceChain/basics/Log.h>
#include <SupplyFinanceChain/core/JobTypeInfo.h>
