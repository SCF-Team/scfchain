...
#ifndef SUPPLYFINANCECHAIN_BASICS_PERFLOGIMP_H
#define SUPPLYFINANCECHAIN_BASICS_PERFLOGIMP_H
    ...
    : public PerfLog, Stoppable
{
    ...
    Counters counters_ {SupplyFinanceChain::RPC::getHandlerNames(), JobTypes::instance()};
...
#endif //SUPPLYFINANCECHAIN_BASICS_PERFLOGIMP_H
