...
#ifndef SUPPLYFINANCECHAIN_BASICS_RANGESET_H_INCLUDED
#define SUPPLYFINANCECHAIN_BASICS_RANGESET_H_INCLUDED
...
{
    using SupplyFinanceChain::to_string;
...
void
save(Archive& ar,
    SupplyFinanceChain::ClosedInterval<T> const& ci,
...
template <class Archive, class T>
void
load(Archive& ar, SupplyFinanceChain::ClosedInterval<T>& ci, const unsigned int version)
{
    T low, up;
    ar >> low >> up;
    ci = SupplyFinanceChain::ClosedInterval<T>{low, up};
}

template <class Archive, class T>
void
serialize(Archive& ar,
    SupplyFinanceChain::ClosedInterval<T>& ci,
    const unsigned int version)
{
...
template <class Archive, class T>
void
save(Archive& ar, SupplyFinanceChain::RangeSet<T> const& rs, const unsigned int version)
{
...
template <class Archive, class T>
void
load(Archive& ar, SupplyFinanceChain::RangeSet<T>& rs, const unsigned int version)
{
    rs.clear();
...
template <class Archive, class T>
void
serialize(Archive& ar, SupplyFinanceChain::RangeSet<T>& rs, const unsigned int version)
{
