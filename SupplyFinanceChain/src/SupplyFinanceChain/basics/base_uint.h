...
#ifndef SUPPLYFINANCECHAIN_BASICS_BASE_UINT_H_INCLUDED
#define SUPPLYFINANCECHAIN_BASICS_BASE_UINT_H_INCLUDED

#include <SupplyFinanceChain/basics/strHex.h>
#include <SupplyFinanceChain/basics/hardened_hash.h>
#include <SupplyFinanceChain/beast/cxx17/type_traits.h>
...
template <std::size_t Bits, class Tag>
struct is_uniquely_represented<SupplyFinanceChain::base_uint<Bits, Tag>>
