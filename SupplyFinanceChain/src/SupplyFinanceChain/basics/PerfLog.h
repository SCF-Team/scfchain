...
#ifndef SUPPLYFINANCECHAIN_BASICS_PERFLOG_H
#define SUPPLYFINANCECHAIN_BASICS_PERFLOG_H
...
public:
    ...
    /**
     * Configuration from [perf] section of SupplyFinanceChaind.cfg.
     */
    struct Setup
    {
...
#endif //SUPPLYFINANCECHAIN_BASICS_PERFLOG_H
