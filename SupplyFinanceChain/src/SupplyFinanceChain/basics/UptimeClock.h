...
#ifndef SUPPLYFINANCECHAIN_BASICS_UPTIMETIMER_H_INCLUDED
#define SUPPLYFINANCECHAIN_BASICS_UPTIMETIMER_H_INCLUDED
...
public:
    ...
    static time_point now();  // seconds since SupplyFinanceChaind program start
