...
*/
//==============================================================================
#ifndef SUPPLYFINANCECHAIN_TEST_CSF_VALIDATION_H_INCLUDED
#define SUPPLYFINANCECHAIN_TEST_CSF_VALIDATION_H_INCLUDED

#include <boost/optional.hpp>
#include <memory>
#include <SupplyFinanceChain/basics/tagged_integer.h>
...
public:
    ...
    unwrap() const
    {
        // For the SupplyFinanceChaind implementation in which RCLValidation wraps
