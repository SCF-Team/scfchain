...
#ifndef SUPPLYFINANCECHAIN_TEST_JTX_OWNERS_H_INCLUDED
#define SUPPLYFINANCECHAIN_TEST_JTX_OWNERS_H_INCLUDED
...
using lines = owner_count<ltSUPPLYFINANCECHAIN_STATE>;
