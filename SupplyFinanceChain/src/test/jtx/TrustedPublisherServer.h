...
/*
    ...
    Copyright 2017 SupplyFinanceChain Labs Inc.
...
*/
//==============================================================================
#ifndef SUPPLYFINANCECHAIN_TEST_TRUSTED_PUBLISHER_SERVER_H_INCLUDED
#define SUPPLYFINANCECHAIN_TEST_TRUSTED_PUBLISHER_SERVER_H_INCLUDED
...
public:
            ...
            : sock_(ioc), acceptor_(ioc)
    {
        endpoint_type const& ep {
            beast::IP::Address::from_string (SupplyFinanceChain::test::getEnvLocalhostAddr()),
