...
#ifndef SUPPLYFINANCECHAIN_TEST_JTX_ENVCONFIG_H_INCLUDED
#define SUPPLYFINANCECHAIN_TEST_JTX_ENVCONFIG_H_INCLUDED
...
/// SupplyFinanceChain::Config. The function takes ownership of the unique_ptr and
