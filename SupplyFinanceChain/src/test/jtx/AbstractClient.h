...
#ifndef SUPPLYFINANCECHAIN_TEST_ABSTRACTCLIENT_H_INCLUDED
#define SUPPLYFINANCECHAIN_TEST_ABSTRACTCLIENT_H_INCLUDED
...
/* Abstract SupplyFinanceChain Client interface.

   This abstracts the transport layer, allowing
   commands to be submitted to a SupplyFinanceChaind server.
*/
