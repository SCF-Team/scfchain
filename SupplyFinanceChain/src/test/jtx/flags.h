...
#ifndef SUPPLYFINANCECHAIN_TEST_JTX_FLAGS_H_INCLUDED
#define SUPPLYFINANCECHAIN_TEST_JTX_FLAGS_H_INCLUDED
...
private:
    ...
    set_args (std::uint32_t flag)
    {
        ...
        case asfDisallowSFC:    mask_ |= lsfDisallowSFC;    break;
        ...
        case asfDefaultSupplyFinanceChain:  mask_ |= lsfDefaultSupplyFinanceChain;  break;
