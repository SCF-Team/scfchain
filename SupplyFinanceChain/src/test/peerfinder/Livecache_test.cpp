...
public:
    ...
    void testHistogram ()
    {
        ...
        for (auto i = 0; i < num_eps; ++i)
            add(
                ...
                c,
                SupplyFinanceChain::rand_int(0, safe_cast<int>(Tuning::maxHops + 1)));
    ...
    void testShuffle ()
    {
        ...
        using at_hop = std::vector <SupplyFinanceChain::PeerFinder::Endpoint>;
...
BEAST_DEFINE_TESTSUITE(Livecache,peerfinder,SupplyFinanceChain);
