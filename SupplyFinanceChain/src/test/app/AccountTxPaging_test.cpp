...
class AccountTxPaging_test : public beast::unit_test::suite
{
    ...
    testAccountTxPaging ()
    {
        ...
        for (auto i = 0; i < 5; ++i)
        {
            ...
            env(offer(A1, SFC(11), A1["USD"](1)));
            env(offer(A2, SFC(10), A2["USD"](1)));
            env(offer(A3, SFC(9),  A3["USD"](1)));
            env.close();
        }
...
BEAST_DEFINE_TESTSUITE(AccountTxPaging,app,SupplyFinanceChain);
