...
#include <SupplyFinanceChain/protocol/ErrorCodes.h>          // RPC::containsError
#include <SupplyFinanceChain/json/json_reader.h>             // Json::Reader
#include <SupplyFinanceChain/protocol/STParsedJSON.h>        // STParsedJSONObject
...
BEAST_DEFINE_TESTSUITE(InnerObjectFormatsParsedJSON,SupplyFinanceChain_app,SupplyFinanceChain);
