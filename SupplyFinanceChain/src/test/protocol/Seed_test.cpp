...
public:
    ...
    {
        std::string const message1 = "http://www.SupplyFinanceChain.com";
        std::string const message2 = "https://www.SupplyFinanceChain.com";
...
BEAST_DEFINE_TESTSUITE(Seed,protocol,SupplyFinanceChain);
