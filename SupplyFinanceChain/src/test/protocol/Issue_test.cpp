...
#ifndef SUPPLYFINANCECHAIN_ASSETS_ENABLE_STD_HASH
# if BEAST_MAC || BEAST_IOS
#  define SUPPLYFINANCECHAIN_ASSETS_ENABLE_STD_HASH 0
# else
#  define SUPPLYFINANCECHAIN_ASSETS_ENABLE_STD_HASH 1
# endif
#endif
...
#if SUPPLYFINANCECHAIN_ASSETS_ENABLE_STD_HASH
...
BEAST_DEFINE_TESTSUITE(Issue,protocol,SupplyFinanceChain);
