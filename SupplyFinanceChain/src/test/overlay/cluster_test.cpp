...
/*
    ...
    Copyright 2015 SupplyFinanceChain Labs Inc.
...
#include <SupplyFinanceChain/overlay/ClusterNode.h>
...
class cluster_test : public SupplyFinanceChain::TestSuite
{
...
BEAST_DEFINE_TESTSUITE(cluster,overlay,SupplyFinanceChain);
