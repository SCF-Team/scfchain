...
public:
    ...
    testGWB(FeatureBitset features)
    {
        ...
        if (wsc->version() == 2)
        {
            ...
            expect(jv.isMember(jss::SupplyFinanceChainrpc) && jv[jss::SupplyFinanceChainrpc] == "2.0");
...
BEAST_DEFINE_TESTSUITE(GatewayBalances,app,SupplyFinanceChain);
