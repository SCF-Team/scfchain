...
class WalletPropose_test : public SupplyFinanceChain::TestSuite
{
public:
    ...
    void testSupplyFinanceChainLibEd25519()
    {
        testcase ("SupplyFinanceChain-lib encoded Ed25519 keys");
    ...
    void run() override
    {
        ...
        testSupplyFinanceChainLibEd25519();

        testKeypairForSignatureErrors ();
    }
};

BEAST_DEFINE_TESTSUITE(WalletPropose,SupplyFinanceChain_basics,SupplyFinanceChain);
