...
{ "Cannot create SFC to SFC paths.", __LINE__,
R"({
    "command": "doesnt_matter",
    "account": "rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",
    "secret": "masterpassphrase",
...
{ "'Amount' may not be SFC for pathfinding, but 'SendMax' may be SFC.", __LINE__,
R"({
    "command": "doesnt_matter",
    "account": "rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh",
    "secret": "masterpassphrase",
...
public:
    ...
    void testTransactionRPC ()
    {
        ...
        test::jtx::Env env(*this);
        env.fund(test::jtx::SFC(100000), a, ed, g);
        env.close();
...
BEAST_DEFINE_TESTSUITE(JSONRPC,SupplyFinanceChain_app,SupplyFinanceChain);
