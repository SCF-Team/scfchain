...
#include <SupplyFinanceChain/net/RPCCall.h>
...
// json2 -----------------------------------------------------------------------
{
    ...
    {
        "json2",
        R"({"jsonrpc":"2.0","SupplyFinanceChainrpc":"2.0","id":"A1","method":"call_1"})",
    },
    RPCCallTestData::no_exception,
    R"({
    "id" : "A1",
...
},
{
    ...
    {
        "json2",
        R"({"jsonrpc":"2.0","SupplyFinanceChainrpc":"2.0","id":"A1","method":"call_this"})",
        "extra"
    },
    RPCCallTestData::no_exception,
    R"({
...
},
{
    ...
    {
        "json2",
        R"({"SupplyFinanceChainrpc":"2.0","id":"A1","method":"call_1"})",
    },
    RPCCallTestData::no_exception,
    R"({
    "id" : "A1",
...
},
{
    ...
    {
        "json2",
        R"({"jsonrpc":"2.1","SupplyFinanceChainrpc":"2.0","id":"A1","method":"call_1"})",
    },
    RPCCallTestData::no_exception,
    R"({
    "id" : "A1",
...
{
    "json2: omit SupplyFinanceChainrpc.", __LINE__,
    {
        "json2",
...
{
    "json2: wrong SupplyFinanceChainrpc version.", __LINE__,
    {
        "json2",
        R"({"jsonrpc":"2.0","SupplyFinanceChainrpc":"2.00","id":"A1","method":"call_1"})",
    },
    RPCCallTestData::no_exception,
    R"({
    "id" : "A1",
...
},
{
    ...
    {
        "json2",
        R"({"jsonrpc":"2.0","SupplyFinanceChainrpc":"2.0","method":"call_1"})",
    },
    RPCCallTestData::no_exception,
    R"({
    "jsonrpc" : "2.0",
...
},
{
    ...
    {
        "json2",
        R"({"jsonrpc":"2.0","SupplyFinanceChainrpc":"2.0","id":"A1"})",
    },
    RPCCallTestData::no_exception,
    R"({
    "id" : "A1",
...
// SupplyFinanceChain_path_find ------------------------------------------------------------
{
    "SupplyFinanceChain_path_find: minimal.", __LINE__,
    {
        "SupplyFinanceChain_path_find",
        R"({"json_argument":true})",
    },
    RPCCallTestData::no_exception,
    R"({
    "method" : "SupplyFinanceChain_path_find",
    "params" : [
      {
         "json_argument" : true
      }
...
{
    "SupplyFinanceChain_path_find: ledger index.", __LINE__,
    {
        "SupplyFinanceChain_path_find",
        R"({"json_argument":true})",
        "4294967295"
...
{
    "SupplyFinanceChain_path_find: text ledger index.", __LINE__,
    {
        "SupplyFinanceChain_path_find",
        R"({"json_argument":true})",
        "closed"
...
{
    "SupplyFinanceChain_path_find: ledger hash.", __LINE__,
    {
        "SupplyFinanceChain_path_find",
        R"({"json_argument":true})",
        "0123456789ABCDEFGHIJKLMNOPQRSTUV0123456789ABCDEFGHIJKLMNOPQRSTUV"
...
{
    "SupplyFinanceChain_path_find: too few arguments.", __LINE__,
    {
        "SupplyFinanceChain_path_find",
    },
    RPCCallTestData::no_exception,
...
{
    "SupplyFinanceChain_path_find: too many arguments.", __LINE__,
    {
        "SupplyFinanceChain_path_find",
        R"({"json_argument":true})",
        "current",
...
{
    "SupplyFinanceChain_path_find: invalid json (note extra comma).", __LINE__,
    {
        "SupplyFinanceChain_path_find",
        R"({"json_argument":true,})",
    },
...
{
    "SupplyFinanceChain_path_find: ledger index too small.", __LINE__,
    {
        "SupplyFinanceChain_path_find",
        R"({"json_argument":true})",
        "-1"
...
{
    "SupplyFinanceChain_path_find: ledger index too big.", __LINE__,
    {
        "SupplyFinanceChain_path_find",
        R"({"json_argument":true})",
        "4294967296"
...
{
    "SupplyFinanceChain_path_find: invalid text ledger index.", __LINE__,
    {
        "SupplyFinanceChain_path_find",
        R"({"json_argument":true})",
        "cur"
...
BEAST_DEFINE_TESTSUITE(RPCCall,app,SupplyFinanceChain);
