...
public:
    ...
    void testNonAdminMinLimit()
    {
        ...
        {
            Json::Value jvo = offer(bob, SFC(100 + i), USD_gw(1));
    ...
    void testSequential(bool asAdmin)
    {
        ...
        env(offer(bob, SFC(100), USD_bob(1)));
        env(offer(bob, SFC(100), USD_gw(1)));
        env(offer(bob, SFC(10),  USD_gw(2)));
...
BEAST_DEFINE_TESTSUITE(AccountOffers,app,SupplyFinanceChain);
