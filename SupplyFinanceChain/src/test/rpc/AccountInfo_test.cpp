   ...
   void testSignerListsV2()
    {
        ...
        // Alice has no SignerList yet.
        {
            ...
            BEAST_EXPECT(info.isMember(jss::SupplyFinanceChainrpc) && info[jss::SupplyFinanceChainrpc] == "2.0");
        ...
        }
        {
            ...
            BEAST_EXPECT(info[0u].isMember(jss::SupplyFinanceChainrpc) && info[0u][jss::SupplyFinanceChainrpc] == "2.0");
            ...
            BEAST_EXPECT(info[1u].isMember(jss::SupplyFinanceChainrpc) && info[1u][jss::SupplyFinanceChainrpc] == "2.0");
...
BEAST_DEFINE_TESTSUITE(AccountInfo,app,SupplyFinanceChain);
