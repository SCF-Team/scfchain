...
class LedgerRPC_test : public beast::unit_test::suite
{
    ...
    // '!' is not part of the SupplyFinanceChain alphabet.
    std::string
    ...
    void testLedgerEntryCheck()
    {
        ...
        env (checkCreate (env.master, alice, SFC(100)));
        env.close();
    ...
    void testLedgerEntryEscrow()
    {
        ...
        env (escrowCreate (alice, alice, SFC(333), env.now() + 2s));
        env.close();
        ...
        std::string escrowIndex;
        {
            ...
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
            BEAST_EXPECT(
                jrr[jss::node][jss::Amount] == SFC(333).value().getText());
    ...
    void testLedgerEntryOffer()
    {
        ...
        env (offer (alice, USD (321), SFC (322)));
        env.close();
    ...
    void testLedgerEntryPayChan()
    {
        ...
        env (payChanCreate (alice, env.master, SFC(57), 18s, alice.pk()));
        env.close();
    ...
    void testLedgerEntrySupplyFinanceChainState()
    {
        testcase ("ledger_entry Request SupplyFinanceChainState");
        using namespace test::jtx;
        Env env {*this};
        Account const alice {"alice"};
        Account const gw { "gateway" };
        ...
        std::string const ledgerHash {to_string (env.closed()->info().hash)};
        {
            ...
            Json::Value jvParams;
            jvParams[jss::SupplyFinanceChain_state] = Json::objectValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts][0u] = alice.human();
            jvParams[jss::SupplyFinanceChain_state][jss::accounts][1u] = gw.human();
            jvParams[jss::SupplyFinanceChain_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
            BEAST_EXPECT(
        ...
        {
            // SupplyFinanceChain_state is not an object.
            Json::Value jvParams;
            jvParams[jss::SupplyFinanceChain_state] = "SupplyFinanceChain_state";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
            checkErrorValue (jrr, "malformedRequest", "");
        ...
        {
            // SupplyFinanceChain_state.currency is missing.
            Json::Value jvParams;
            jvParams[jss::SupplyFinanceChain_state] = Json::objectValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts][0u] = alice.human();
        ...
        {
            // SupplyFinanceChain_state accounts is not an array.
            Json::Value jvParams;
            jvParams[jss::SupplyFinanceChain_state] = Json::objectValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts] = 2;
            jvParams[jss::SupplyFinanceChain_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
        ...
        {
            // SupplyFinanceChain_state one of the accounts is missing.
            Json::Value jvParams;
            jvParams[jss::SupplyFinanceChain_state] = Json::objectValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts][0u] = alice.human();
        ...
        {
            // SupplyFinanceChain_state more than 2 accounts.
            Json::Value jvParams;
            jvParams[jss::SupplyFinanceChain_state] = Json::objectValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts][0u] = alice.human();
            jvParams[jss::SupplyFinanceChain_state][jss::accounts][1u] = gw.human();
            jvParams[jss::SupplyFinanceChain_state][jss::accounts][2u] = alice.human();
            jvParams[jss::SupplyFinanceChain_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
        ...
        {
            // SupplyFinanceChain_state account[0] is not a string.
            Json::Value jvParams;
            jvParams[jss::SupplyFinanceChain_state] = Json::objectValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts][0u] = 44;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts][1u] = gw.human();
            jvParams[jss::SupplyFinanceChain_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
        ...
        {
            // SupplyFinanceChain_state account[1] is not a string.
            Json::Value jvParams;
            jvParams[jss::SupplyFinanceChain_state] = Json::objectValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts][0u] = alice.human();
            jvParams[jss::SupplyFinanceChain_state][jss::accounts][1u] = 21;
            jvParams[jss::SupplyFinanceChain_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
        ...
        {
            // SupplyFinanceChain_state account[0] == account[1].
            Json::Value jvParams;
            jvParams[jss::SupplyFinanceChain_state] = Json::objectValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts][0u] = alice.human();
            jvParams[jss::SupplyFinanceChain_state][jss::accounts][1u] = alice.human();
            jvParams[jss::SupplyFinanceChain_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
        ...
        {
            // SupplyFinanceChain_state malformed account[0].
            Json::Value jvParams;
            jvParams[jss::SupplyFinanceChain_state] = Json::objectValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts][0u] =
        ...
        {
            // SupplyFinanceChain_state malformed account[1].
            Json::Value jvParams;
            jvParams[jss::SupplyFinanceChain_state] = Json::objectValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts][0u] = alice.human();
            jvParams[jss::SupplyFinanceChain_state][jss::accounts][1u] =
        ...
        {
            // SupplyFinanceChain_state malformed currency.
            Json::Value jvParams;
            jvParams[jss::SupplyFinanceChain_state] = Json::objectValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::SupplyFinanceChain_state][jss::accounts][0u] = alice.human();
            jvParams[jss::SupplyFinanceChain_state][jss::accounts][1u] = gw.human();
            jvParams[jss::SupplyFinanceChain_state][jss::currency] = "USDollars";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
    ...
    void testLookupLedger()
    {
        ...
        env.fund(SFC(10000), "alice");
        env.close();
        env.fund(SFC(10000), "bob");
        env.close();
        env.fund(SFC(10000), "jim");
        env.close();
        env.fund(SFC(10000), "jill");
    ...
    void testQueue()
    {
        ...
        env.fund(SFC(10000), bob);
        env.close();
        env.fund(SFC(10000), charlie);
        env.fund(SFC(10000), daria);
        env.close();
        ...
        env(pay(alice, "george", SFC(1000)), json(R"({"LastLedgerSequence":7})"),
            ter(terQUEUED));
        env(offer(alice, SFC(50000), alice["USD"](5000)), seq(aliceSeq + 1),
            ter(terQUEUED));
...
public:
    void run () override
    {
        ...
        testLedgerEntrySupplyFinanceChainState();
...
BEAST_DEFINE_TESTSUITE(LedgerRPC,app,SupplyFinanceChain);
