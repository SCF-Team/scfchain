...
public:
    void testAccountLines()
    {
        ...
        for (char c = 0; c <= ('Z' - 'A'); ++c)
        {
            ...
            env(trust(alice, gw2Currency(0), gw2, tfSetNoSupplyFinanceChain | tfSetFreeze));
        }
        env.close();
        ...
        }
        {
            ...
            BEAST_EXPECT(line[jss::no_SupplyFinanceChain].asBool() == true);
        ...
        }
        {
            ...
            BEAST_EXPECT(lineA[jss::no_SupplyFinanceChain_peer].asBool() == true);
    ...
    void testAccountLineDelete()
    {
        ...
        //   o alice offers to buy 100 USD for 100 SFC.
        //   o becky offers to sell 100 USD for 100 SFC.
        ...
        Account const gw1 {"gw1"};
        Account const gw2 {"gw2"};
        env.fund(SFC(10000), alice, becky, cheri, gw1, gw2);
        env.close();
        ...
        // alice offers to buy 100 EUR for 100 SFC.
        env(offer(alice, EUR(100), SFC(100)));
        env.close();

        // becky offers to buy 100 SFC for 100 EUR.
        env(offer(becky, SFC(100), EUR(100)));
        env.close();
    ...
    void testAccountLines2()
    {
        ...
        Env env(*this);
        {
            ...
            auto const lines = env.rpc ("json2", "{ "
                ...
                R"("jsonrpc" : "2.0",)"
                R"("SupplyFinanceChainrpc" : "2.0")"
                " }");
            BEAST_EXPECT(lines.isMember(jss::jsonrpc) && lines[jss::jsonrpc] == "2.0");
            BEAST_EXPECT(lines.isMember(jss::SupplyFinanceChainrpc) && lines[jss::SupplyFinanceChainrpc] == "2.0");
        }
        {
            // account_lines with no account.
            auto const lines = env.rpc ("json2", "{ "
        ...
        [this, &env](Account const& account, LedgerInfo const& info, int count)
        {
            ...
            BEAST_EXPECT(linesSeq.isMember(jss::SupplyFinanceChainrpc) && linesSeq[jss::SupplyFinanceChainrpc] == "2.0");
            ...
            BEAST_EXPECT(linesHash.isMember(jss::SupplyFinanceChainrpc) && linesHash[jss::SupplyFinanceChainrpc] == "2.0");
        ...
        }
        {
            ...
            BEAST_EXPECT(linesA.isMember(jss::SupplyFinanceChainrpc) && linesA[jss::SupplyFinanceChainrpc] == "2.0");
            ...
            BEAST_EXPECT(linesB.isMember(jss::SupplyFinanceChainrpc) && linesB[jss::SupplyFinanceChainrpc] == "2.0");
            ...
            BEAST_EXPECT(linesC.isMember(jss::SupplyFinanceChainrpc) && linesC[jss::SupplyFinanceChainrpc] == "2.0");
            ...
            BEAST_EXPECT(linesD.isMember(jss::SupplyFinanceChainrpc) && linesD[jss::SupplyFinanceChainrpc] == "2.0");
    ...
    void testAccountLineDelete2()
    {
        ...
        //   o alice offers to buy 100 EUR for 100 SFC.
        //   o becky offers to sell 100 EUR for 100 SFC.
        ...
        BEAST_EXPECT(linesBeg.isMember(jss::SupplyFinanceChainrpc) && linesBeg[jss::SupplyFinanceChainrpc] == "2.0");
        ...
        BEAST_EXPECT(linesEnd.isMember(jss::SupplyFinanceChainrpc) && linesEnd[jss::SupplyFinanceChainrpc] == "2.0");
...
BEAST_DEFINE_TESTSUITE(AccountLinesRPC,app,SupplyFinanceChain);
