...
#include <SupplyFinanceChain/basics/ToString.h>
...
public:
    ...
    void testUnHex ()
    {
        ...
        testUnHexSuccess ("526970706c6544", "SupplyFinanceChainD");
        testUnHexSuccess ("A", "\n");
        testUnHexSuccess ("0A", "\n");
...
BEAST_DEFINE_TESTSUITE(StringUtilities, SupplyFinanceChain_basics, SupplyFinanceChain);
