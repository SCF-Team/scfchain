...
#include <SupplyFinanceChain/beast/xor_shift_engine.h>
...
public:
    ...
    */
    ...
    // Simulate a SupplyFinanceChaind workload:
...
BEAST_DEFINE_TESTSUITE_MANUAL_PRIO(Timing,NodeStore,SupplyFinanceChain,1);
